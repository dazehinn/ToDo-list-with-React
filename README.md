...
* in the code editor, open the terminal.
* enter `npm install` to install all necessary node modules


### Usage
enter `npm run dev` in the terminal to set the project running
